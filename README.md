...
List the number of songs per artist in descending order 3 results

Which artist or artists have recorded the most number of songs? 4 results

Which artist or artists have recorded the least number of songs? 5 results

How many artists have recorded the least number of songs? Hint: we can wrap the results of query 5. with another select to give us total artist count.
6 results

Which artists have recorded songs longer than 5 minutes, and if so, how many songs were recorded? 7 results

For each artist and album how many songs were less than 5 minutes long? 8 results

In which year or years were the most songs recorded?
9 results

List the artist, song and year of the top 5 longest recorded songs 10 results

List a table showing the Number of albums recorded for each year.
11 results

What is the max number of recorded albums across all the years? Hint: using the above sql as a temp table 12 results

In which year (or years) were the most (max) number of albums recorded, and how many were recorded? 13 results

List the total duration of all songs recorded by each artist in descending order. 14 results

for which artist and album are there no songs less than 5 minutes long? 15 results

Display a table of all artists, albums, songs and song duration, all ordered in ascending order by artist, album and song. 16 results

List the top 3 artists with the longest average song duration, in descending with longest average first. 17 results

What is the total album length for all songs on the Beatles Sgt. Pepper's album - in minutes and seconds. 18 results

Which artists did not release an album during the decades of the 1980's and the 1990's? 19 results

Which artists did release an album during the decades of the 1980's and the 1990's? 20 results
